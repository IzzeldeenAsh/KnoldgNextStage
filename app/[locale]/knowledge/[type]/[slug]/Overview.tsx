                    ...
                    {!isOwner && (
                      ...
                      {doc.is_purchased ? (
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            window.location.href = process.env.NEXT_PUBLIC_DASHBOARD_URL + '/app/insighter-dashboard/my-downloads' || 'https://app.foresightaa.co/app/insighter-dashboard/my-downloads';
                          }}
