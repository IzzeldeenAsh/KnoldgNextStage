...
export default function Reviews({ knowledgeSlug, reviews, is_review, is_owner }: ReviewsProps) {
  ...
  const fetchUpdatedReviews = async () => {
    try {
      ...
      const response = await fetch(
        `https://api.foresightaa.co/api/platform/industries/knowledge/${knowledgeSlug}`,
        {
          method: "GET",
          headers,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://api.foresightaa.co/api/account/review/knowledge/${knowledgeSlug}`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const deleteReview = async (reviewId: number) => {
    ...
    try {
      const response = await fetch(
        `https://api.foresightaa.co/api/account/review/knowledge/${reviewId}`,
        {
          method: 'DELETE',
          headers: {
            "Content-Type": "application/json",
