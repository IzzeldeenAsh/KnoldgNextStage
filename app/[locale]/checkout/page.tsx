...
export default function CheckoutPage() {
    ...
    const fetchKnowledgeData = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `https://api.foresightaa.co/api/platform/industries/knowledge/${slug}`,
          {
            headers: {
  ...
  useEffect(() => {
    const fetchWalletBalance = async () => {
      try {
        ...
        const response = await fetch(
          "https://api.foresightaa.co/api/account/wallet/balance",
          {
            headers: {
              "Content-Type": "application/json",
              Accept: "application/json",
  ...
  const fetchUpdatedOrderDetails = async (uuid: string) => {
    try {
      ...
      const token = getAuthToken();
      const response = await fetch(
        `https://api.foresightaa.co/api/account/order/knowledge/${uuid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Accept: "application/json",
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://api.foresightaa.co/api/account/order/knowledge/checkout",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    if (knowledgeDownloadId) {
                      ...
                      window.location.href = `https://app.foresightaa.co/app/insighter-dashboard/my-downloads${uuidsParam}`;
                    } else {
                      ...
                      window.location.href = `https://app.foresightaa.co/app/insighter-dashboard/my-downloads${searchParam}`;
                    }
                  }}
                >
