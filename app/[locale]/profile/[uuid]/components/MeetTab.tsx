...
export default function MeetTab({
  ...
  const fetchWalletBalance = async () => {
    try {
      ...
      const response = await fetch("https://api.foresightaa.co/api/account/wallet/balance", {
        headers: {
  ...
  const checkDuplicateMeetingTime = async (
    ...
    try {
      ...
      const response = await fetch(
        "https://api.foresightaa.co/api/account/meeting/client/check-duplicate-time",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const pollOrderStatus = async (orderUuid: string): Promise<boolean> => {
    ...
    const checkStatus = async (): Promise<boolean> => {
      try {
        const response = await fetch(
          `https://api.foresightaa.co/api/account/order/meeting/${orderUuid}`,
          {
            headers: {
              "Content-Type": "application/json",
              Accept: "application/json",
  ...
  const submitBookMeeting = async (skipDuplicateCheck = false) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://api.foresightaa.co/api/account/order/meeting/checkout/${uuid}`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      <div className="flex flex-col items-center max-w-3xl mx-auto">
        ...
        {!authChecked ? (
          ...
          <div className="text-center py-16">
            ...
            <a
              href={`https://app.foresightaa.co/auth/login?returnUrl=${encodeURIComponent(
                `https://foresightaa.co/${locale}/profile/${uuid}${
