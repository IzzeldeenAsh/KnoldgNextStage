...
export default function SignoutPage() {
  ...
  useEffect(() => {
    ...
    const removeCookie = (name: string) => {
      ...
      document.cookie = `${name}=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/; Domain=.foresightaa.co; Secure; SameSite=None;`;
    };
    ...
    localStorage.removeItem('foresightaa-creds'); // Angular format
    ...
    const shouldNotifyAngularApp = !redirectUri?.includes('app.foresightaa.co');
    ...
    if (shouldNotifyAngularApp) {
      ...
      angularLogoutFrame.src = `https://app.foresightaa.co/auth/logout?redirect_uri=${encodeURIComponent(window.location.href)}`;
