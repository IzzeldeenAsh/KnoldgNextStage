export const metadata = {
  title: 'Integrations Post - FORESIGHTA',
                  ...
                  <div className="shrink-0">
                    <div className="sticky top-6">
                      <Link className="flex items-center justify-center w-9 h-9 group border border-transparent rounded-full [background:linear-gradient(theme(colors.slate.900),_theme(colors.slate.900))_padding-box,_conic-gradient(theme(colors.slate.400),_theme(colors.slate.700)_25%,_theme(colors.slate.700)_75%,_theme(colors.slate.400)_100%)_border-box] relative before:absolute before:inset-0 before:bg-slate-800/30 before:rounded-full before:pointer-events-none" href="/integrations">
                        ...
                        <svg className="w-4 h-4 fill-blue-500" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div>
                    <article className="pb-12 mb-12 border-b [border-image:linear-gradient(to_right,transparent,theme(colors.slate.800),transparent)1]">
                      ...
                      <div className="prose max-w-none text-slate-400 prose-headings:text-slate-50 prose-h2:text-xl prose-h2:mt-8 prose-h2:mb-4 prose-p:leading-relaxed prose-a:text-blue-500 prose-a:no-underline hover:prose-a:underline prose-strong:text-slate-50 prose-strong:font-medium prose-blockquote:pl-5 prose-blockquote:xl:-ml-5 prose-blockquote:border-l-2 prose-blockquote:border-blue-500 prose-blockquote:font-medium prose-blockquote:text-slate-300 prose-blockquote:italic">
                        <h2>Overview</h2>
                        <p>
                          This powerful GitHub integration keeps your work in sync in both applications. It links features to Pull Requests so that details update automatically from In Progress to Done as the PR moves from drafted to merged - there is no need to update the issue in FORESIGHTA at all.
                        </p>
                        <p>
                        ...
                        <h2>How it works</h2>
                        <p>
                          Configure the GitHub integration <strong className="text-slate-50 font-medium">in a couple of minutes</strong> by authenticating and selecting which repos to connect to FORESIGHTA. Once you do, anyone in the workspace can start linking PRs.
                        </p>
                        <p>
                    ...
                    <aside className="pl-6 border-l-2 border-blue-500">
                      ...
                      <footer className="flex items-center space-x-4">
                        ...
                        <div className="text-sm font-medium text-slate-300">
                          Mike Hunt <span className="text-slate-700">-</span> <a className="text-blue-500 hover:underline" href="#0">Thunderbolt</a>
                        </div>
                      </footer>
                    </aside>
                  </div>
                    ...
                    <div className="px-5 py-6">
                      ...
                      <ul className="text-sm">
                        ...
                        <li className="flex items-center justify-between space-x-2 py-3 border-t [border-image:linear-gradient(to_right,theme(colors.slate.700/.3),theme(colors.slate.700),theme(colors.slate.700/.3))1]">
                          ...
                          <a className="text-blue-500 font-medium flex items-center space-x-1" href="#0">
