export const metadata = {
  title: 'Customer Post - FORESIGHTA',
            ...
            <div className="md:grow pb-12 md:pb-20">
              <div className="max-w-3xl">
                ...
                <article className="pb-12 mb-12 border-b [border-image:linear-gradient(to_right,transparent,theme(colors.slate.800),transparent)1]">
                  ...
                  <div className="mb-4">
                    <Link className="inline-flex text-sm font-medium text-blue-500 group" href="/customers"><span className="tracking-normal group-hover:-translate-x-0.5 transition-transform duration-150 ease-in-out mr-1">&lt;-</span> Go Back</Link>
                  </div>

                  <header>
                    <h1 className="h2 inline-flex bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">How Airbnb leverages FORESIGHTA X to onboard new hosts</h1>
                    ...
                    <div className="px-5 py-6">
                      ...
                      <ul className="text-sm">
                        ...
                        <li className="flex items-center justify-between space-x-2 py-3 border-t [border-image:linear-gradient(to_right,theme(colors.slate.700/.3),theme(colors.slate.700),theme(colors.slate.700/.3))1]">
                          ...
                          <span className="text-slate-300 font-medium">FORESIGHTA X</span>
                        </li>
                        <li className="flex items-center justify-between space-x-2 py-3 border-t [border-image:linear-gradient(to_right,theme(colors.slate.700/.3),theme(colors.slate.700),theme(colors.slate.700/.3))1]">
