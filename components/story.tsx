            ...
            <div className="md:flex justify-between space-x-6 md:space-x-8 lg:space-x-14">
              ...
              <div className="max-w-[548px] mx-auto">
                <div className="text-slate-400 space-y-6">
                  ...
                  <p>
                    FORESIGHTA is a product that connects people around the topics and ideas that fascinate them. <strong className="text-slate-50 font-medium">The idea that we can use technology to take our experience</strong>, as security lovers, to a new dimension and leave the computer industry in better shape while we're at it.
                  </p>
                  <p>
                  ...
                  <p>
                    Contrary to popular belief, this product is not random security. It has roots in a piece of classical literature, making it over 5 years old. Richard McClintock, a professor at <a className="text-blue-500 font-medium hover:underline" href="#0">Hampden-Sydney College</a> in Virginia, looked up one of the more obscure words, consectetur from a passage, and going through the cites of the word in classical literature, discovered the undoubtable source.
                  </p>
                  <p>
