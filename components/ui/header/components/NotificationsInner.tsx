...
export default function NotificationsInner({ 
  ...
  const handleNotificationClick = async (notification: Notification) => {
    ...
    if (notification.sub_type === 'accept_knowledge') {
      window.location.href = 'https://app.foresightaa.co/app/insighter-dashboard/my-requests'
      return
    }
    if (notification.sub_type === 'declined' && notification.type === 'knowledge') {
      window.location.href = `https://app.foresightaa.co/app/my-knowledge-base/view-my-knowledge/${notification.param}/details`
      return
    }
    if(notification.sub_type.startsWith('client_')) {
      window.location.href = 'https://app.foresightaa.co/app/insighter-dashboard/my-meetings/sent'
      return
    }
    if(notification.sub_type.startsWith('insighter_')) {
      window.location.href = 'https://app.foresightaa.co/app/insighter-dashboard/my-meetings/received'
      return
    }
    ...
    if (notification.type === 'knowledge' && notification.category) {
      const knowledgeUrl = `https://foresightaa.co/${currentLanguage}/knowledge/${notification.category}/${notification.param || ''}?tab=ask`
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundImage: 'url(https://app.foresightaa.co/assets/media/misc/menu-header-bg.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}
      >
