...
export default function NotificationsInner({
  ...
  const handleNotificationClick = async (notification: Notification) => {
    ...
    if (notification.type === 'order') {
      window.location.href = 'https://app.foresighta.co/app/insighter-dashboard/sales?tab=2'
      return
    }
    ...
    if(notification.sub_type.startsWith('client_meeting_reminder')){
      window.location.href = 'https://app.foresighta.co/app/insighter-dashboard/my-meetings?tab=client'
      return
    }
