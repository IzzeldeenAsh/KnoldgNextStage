...
export function UserProfile({ isHome }: { isHome: boolean }) {
  ...
  if (!user) {
    return (
      <>
        <Link
          href="https://app.foresightaa.co/auth/login"
      ...
      {menuOpen && (
        ...
        >
          ...
          <div className="py-2 px-3">
            ...
            <>
              <Link
                href="https://app.foresightaa.co/app/add-knowledge/stepper"
              ...
              >
               ...
               <Link
               href="https://app.foresightaa.co/app/insighter-dashboard/my-knowledge/general"
            ...
            <Link
              href="https://app.foresightaa.co/app/profile/overview"
            ...
            <Link
              href="https://app.foresightaa.co/app/insighter-dashboard/my-dashboard"
              className="block px-4 py-2.5 font-semibold text-slate-900 hover:bg-indigo-50 hover:text-sky-700"
              onClick={() => setMenuOpen(false)}
              style={{fontSize: '13px'}}
            >
            ...
            {/* <Link
            href="https://app.foresightaa.co/app/insighter-dashboard/my-consulting-schedule"
            className="block px-4 py-2.5 font-semibold text-slate-900 hover:bg-indigo-50 hover:text-sky-700"
            onClick={() => setMenuOpen(false)}
            style={{fontSize: '13px'}}
            >
            ...
            {!isClient$() && (
              <>
                {/* <Link
                  href="https://app.foresightaa.co/app/insighter-dashboard/my-requests"
                  className="block px-4 py-2.5 font-semibold text-slate-900 hover:bg-indigo-50 hover:text-sky-700"
                  onClick={() => setMenuOpen(false)}
                  style={{fontSize: '13px'}}
                >
                ...
                {/* <Link
                  href="https://app.foresightaa.co/app/insighter-dashboard/my-meetings/received"
                  className="block px-4 py-2.5 font-semibold text-slate-900 hover:bg-indigo-50 hover:text-sky-700"
                  onClick={() => setMenuOpen(false)}
                  style={{fontSize: '13px'}}
                >
                ...
                <Link
                  href="https://app.foresightaa.co/app/insighter-dashboard/account-settings/general-settings"
                  className="block px-4 py-2.5 font-semibold text-slate-900 hover:bg-indigo-50 hover:text-sky-700"
                  onClick={() => setMenuOpen(false)}
                  style={{fontSize: '13px'}}
                >
            ...
            {/* {roles.includes('company') && 
              <Link
                href="https://app.foresightaa.co/app/insighter-dashboard/my-company-settings"
                className="block px-4 py-2.5 font-semibold text-slate-900 hover:bg-indigo-50 hover:text-sky-700"
                onClick={() => setMenuOpen(false)}
                style={{fontSize: '13px'}}
              >
            ...
            {roles.includes("client") &&
              ...
              !roles.includes("company-insighter") && (
                <>
                <Link
                  href="https://app.foresightaa.co/app/insighter-register/vertical"
