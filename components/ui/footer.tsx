          ...
          <div className="sm:col-span-12 lg:col-span-4 order-1 lg:order-none text-center sm:text-left">
            <div className="h-full flex flex-col sm:flex-row lg:flex-col justify-between items-center sm:items-start">
              ...
              <ul className="flex space-x-4 justify-center sm:justify-start">
                {/* LinkedIn */}
                <li>
                  <a className="flex justify-center items-center text-blue-500 hover:text-blue-400 transition duration-150 ease-in-out" href="https://www.linkedin.com/company/foresighta" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                ...
                {/* Twitter */}
                <li>
                  <a className="mx-4 flex justify-center items-center text-blue-500 hover:text-blue-400 transition duration-150 ease-in-out" href="https://x.com/foresighta75651" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
                    <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
