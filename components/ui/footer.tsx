        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12">
          ...
          <div className="sm:col-span-12 lg:col-span-3 order-1 lg:order-none text-center sm:text-left">
            <div className="h-full flex flex-col sm:flex-row lg:flex-col justify-between items-center sm:items-start">
              ...
              <ul className="flex space-x-4 justify-center sm:justify-start">
                ...
                <li>
                  <a
                    className="flex justify-center items-center text-blue-500 hover:text-blue-400 transition duration-150 ease-in-out"
                    href={isRTL ? "https://www.linkedin.com/company/insighta-business-ar/" : "https://www.linkedin.com/company/insighta-global/"}
                    target="_blank"
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2 text-center sm:text-left">
            ...
            <ul className="text-sm space-y-2 text-start">
              ...
              <li>
              <a className="text-slate-400 hover:text-slate-200 transition duration-150 ease-in-out" href={`/${locale}/resources/first-steps/insighter-guide/what-is-an-insighter`}>{t('firstSteps.insighterGuide')}</a>
              </li>
              <li>
