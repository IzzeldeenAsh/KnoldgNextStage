...
export default function Customers() {
  ...
  const items = [
    {
      img: CustomerImg01,
      quote: "I love FORESIGHTA, is super easy to use with top notch features. My favourites are the affiliates and the lovely login box that converts like magic.",
      name: 'Mike Smets',
      twitter: {
        handle: '@MikeSmets',
        link: '#0'
    ...
    <section className="relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none -z-10" aria-hidden="true">
        <div className="absolute flex items-center justify-center top-0 -translate-y-1/2 left-1/2 -translate-x-1/2 w-1/3 aspect-square">
          <div className="absolute inset-0 translate-z-0 bg-blue-500 rounded-full blur-[120px] opacity-50"></div>
        </div>
      </div>
