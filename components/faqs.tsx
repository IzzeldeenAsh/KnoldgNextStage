    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      <div className="py-12 md:py-20 border-t [border-image:linear-gradient(to_right,transparent,theme(colors.slate.800),transparent)1]">
        ...
        <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          <div>
            <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-blue-200 pb-3">Getting started with FORESIGHTA</div>
          </div>
        ...
        <div className="md:flex md:space-x-12 space-y-8 md:space-y-0">
          ...
          <div className="w-full md:w-1/2 space-y-8">
            ...
            <div className="space-y-2">
              <h4 className="font-semibold">What is FORESIGHTA?</h4>
            ...
            {/* Item */}
            <div className="space-y-2">
              <h4 className="font-semibold">What's an affordable alternative to FORESIGHTA?</h4>
              <p className="text-slate-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim lobortis scelerisque fermentum.</p>
            </div>

            {/* Item */}
            <div className="space-y-2">
              <h4 className="font-semibold">Can I remove the 'Powered by FORESIGHTA' branding?</h4>
              <p className="text-slate-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim lobortis scelerisque fermentum.</p>
            </div>
          ...
          <div className="w-full md:w-1/2 space-y-8">
            ...
            {/* Item */}
            <div className="space-y-2">
              <h4 className="font-semibold">Can I use FORESIGHTA for free?</h4>
              <p className="text-slate-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim lobortis scelerisque fermentum.</p>
            </div>

            {/* Item */}
            <div className="space-y-2">
              <h4 className="font-semibold">Is FORESIGHTA affordable for small businesses?</h4>
              <p className="text-slate-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim lobortis scelerisque fermentum.</p>
            </div>
